...
public final class MessagingGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<si.ita.services.orders.messaging.CreateRequest,
      si.ita.services.orders.messaging.CreateResponse> getSendMessageToQueueMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessageToQueue",
      requestType = si.ita.services.orders.messaging.CreateRequest.class,
      responseType = si.ita.services.orders.messaging.CreateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<si.ita.services.orders.messaging.CreateRequest,
      si.ita.services.orders.messaging.CreateResponse> getSendMessageToQueueMethod() {
    io.grpc.MethodDescriptor<si.ita.services.orders.messaging.CreateRequest, si.ita.services.orders.messaging.CreateResponse> getSendMessageToQueueMethod;
      ...
      synchronized (MessagingGrpc.class) {
        if ((getSendMessageToQueueMethod = MessagingGrpc.getSendMessageToQueueMethod) == null) {
          MessagingGrpc.getSendMessageToQueueMethod = getSendMessageToQueueMethod =
              io.grpc.MethodDescriptor.<si.ita.services.orders.messaging.CreateRequest, si.ita.services.orders.messaging.CreateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendMessageToQueue"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.ita.services.orders.messaging.CreateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.ita.services.orders.messaging.CreateResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<si.ita.services.orders.messaging.CreateRequest,
      si.ita.services.orders.messaging.CreateResponse> getReadMessagesFromQueueMethod;
  ...
  public static io.grpc.MethodDescriptor<si.ita.services.orders.messaging.CreateRequest,
      si.ita.services.orders.messaging.CreateResponse> getReadMessagesFromQueueMethod() {
    io.grpc.MethodDescriptor<si.ita.services.orders.messaging.CreateRequest, si.ita.services.orders.messaging.CreateResponse> getReadMessagesFromQueueMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sendMessageToQueue(si.ita.services.orders.messaging.CreateRequest request,
        io.grpc.stub.StreamObserver<si.ita.services.orders.messaging.CreateResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendMessageToQueueMethod(), responseObserver);
    }

    /**
     */
    default void readMessagesFromQueue(si.ita.services.orders.messaging.CreateRequest request,
        io.grpc.stub.StreamObserver<si.ita.services.orders.messaging.CreateResponse> responseObserver) {
  ...
  public static final class MessagingStub
    ...
    /**
     */
    public void sendMessageToQueue(si.ita.services.orders.messaging.CreateRequest request,
        io.grpc.stub.StreamObserver<si.ita.services.orders.messaging.CreateResponse> responseObserver) {
    ...
    /**
     */
    public void readMessagesFromQueue(si.ita.services.orders.messaging.CreateRequest request,
        io.grpc.stub.StreamObserver<si.ita.services.orders.messaging.CreateResponse> responseObserver) {
  ...
  public static final class MessagingBlockingStub
    ...
    /**
     */
    public si.ita.services.orders.messaging.CreateResponse sendMessageToQueue(si.ita.services.orders.messaging.CreateRequest request) {
    ...
    /**
     */
    public java.util.Iterator<si.ita.services.orders.messaging.CreateResponse> readMessagesFromQueue(
        si.ita.services.orders.messaging.CreateRequest request) {
  ...
  public static final class MessagingFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<si.ita.services.orders.messaging.CreateResponse> sendMessageToQueue(
        si.ita.services.orders.messaging.CreateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE_TO_QUEUE:
          serviceImpl.sendMessageToQueue((si.ita.services.orders.messaging.CreateRequest) request,
              (io.grpc.stub.StreamObserver<si.ita.services.orders.messaging.CreateResponse>) responseObserver);
          break;
        case METHODID_READ_MESSAGES_FROM_QUEUE:
          serviceImpl.readMessagesFromQueue((si.ita.services.orders.messaging.CreateRequest) request,
              (io.grpc.stub.StreamObserver<si.ita.services.orders.messaging.CreateResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              si.ita.services.orders.messaging.CreateRequest,
              si.ita.services.orders.messaging.CreateResponse>(
  ...
  private static abstract class MessagingBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return si.ita.services.orders.messaging.MessagingProto.getDescriptor();
    }
